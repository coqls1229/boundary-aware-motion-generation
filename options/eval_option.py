...
class EvalT2MOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--res_name', type=str, default='rtrans_bert', help='Model name of residual transformer')
        self.parser.add_argument('--text_path', type=str, default="", help='Text prompt file')
        self.parser.add_argument(
            '--text_prompts',
            nargs='*',
            default=None,
            help='One or more text prompts passed directly on the command line.',
        )
        self.parser.add_argument(
            '--motion_lengths',
            nargs='*',
            type=int,
            default=None,
            help='Optional motion lengths for --text_prompts, one value per prompt.',
        )
