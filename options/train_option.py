...
class TrainT2MOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--auto_resume', dest='auto_resume', action='store_true',
                                 help='Automatically resume from latest.tar when it exists.')
        self.parser.add_argument('--no_auto_resume', dest='auto_resume', action='store_false',
                                 help='Start from scratch even when latest.tar exists.')
        self.parser.set_defaults(auto_resume=True)
...
class TrainLenEstOptions():
    def __init__(self):
        ...
        self.parser.add_argument('--max_epoch', type=int, default=500, help='Training iterations')
