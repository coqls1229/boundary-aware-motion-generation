...
T2M_DATA_ROOT = '/local_datasets/motion_generation/humanml3d'
T2M_MOTION_DIR = '/local_datasets/motion_generation/humanml3d/motions/full_motion/263npy'
T2M_TEXT_DIR = '/local_datasets/motion_generation/humanml3d/texts/full_text/txt'
T2M_MAX_MOTION_LENGTH = 196
clip_version = None
...
if __name__ == '__main__':
    ...
    if opt.dataset_name == 't2m':
        eval_val_loader, _ = get_dataset_motion_loader(
            ...
            'test',
            device=opt.device,
            data_root=T2M_DATA_ROOT,
            motion_dir=T2M_MOTION_DIR,
            text_dir=T2M_TEXT_DIR,
            max_motion_length=T2M_MAX_MOTION_LENGTH,
        )
    else:
    ...
    for file in os.listdir(model_dir):
        ...
        for i in range(repeat_time):
            ...
            print("CHECK: evaluation output NaN/Inf")

            if np.isnan(best_fid) or np.isinf(best_fid):
                print("❌ FID is NaN/Inf")
